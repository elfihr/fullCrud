  ...
  return (
    <section className='min-h-[80vh] flex flex-col justify-center items-center'>
      <div className='shadow-2xl px-8 py-8  flex flex-col justify-center items-center' >
        ...
        <Button variant='contained' sx={{ backgroundColor: '#C7253E', "&:hover": { backgroundColor: "#E85C0D" } }}>Register</Button>
        <p>Already have a Accout?<Link to='/login' className='underline'>Login</Link></p>
      </div>
